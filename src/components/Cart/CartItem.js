  ...
  return (
    <div className={styles["cart-item-wrap"]}>
      <div className={styles["left-col"]}>
        ...
        <div>
          <div>
            <ItemsQuantity quantity={quantity} increase={increase} count={count} id={item.id} decrease={decrease} />
          </div>
        </div>
        <div className={styles['trash-bin']} onClick={()=> deleteOrder(item)}><GoTrash /></div>
