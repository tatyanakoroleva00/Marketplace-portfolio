  ...
  return (
    <Carousel interval={15000} wrap={true}>
      <Carousel.Item  style={slideStyle}>
        ...
        <p className={`${styles.capture} ${styles.capture1}`}>только натуральные продукты</p>
      </Carousel.Item>
      <Carousel.Item style={slideStyle}>
        <img className={`${styles.image2} ${["d-block w-100"]}`} src={slide2} alt="Second slide" />
        <p className={`${styles.capture} ${styles.capture2}`}>по выгодным ценам</p>
      </Carousel.Item>
      <Carousel.Item style={slideStyle}>
        <img className={`${styles.image3} ${["d-block w-100"]}`} src={slide3} alt="Third slide" />
        <p className={`${styles.capture} ${styles.capture3}`}>25%</p>
